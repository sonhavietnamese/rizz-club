...
export default function Landing() {
  ...
  const { appStatus, loginWithUI, accountDetails, userDetails } = useWepin()
  ...
  return (
    <motion.main className="w-screen h-screen flex items-center justify-center bg-[#E3E3E3] p-6">
      ...
      >
        <motion.div
          animate={{
            opacity: !['prepare', 'logged-in', 'checked-user'].includes(stage)
              ? 0
              : 1,
          }}
          id="landing"
        >
          ...
          <div className="absolute top-8 right-8 font-bold">
          ...
          <div className="p-2 rounded-full bg-[#EFEFEF] z-10 absolute top-8 right-8 leading-none font-proxima text-[18px]">
            <button
              className={cn(
